...
- [Razorpay production dependencies](razorpay-commonjs-interop.md) — Hostinger misses nested SDK modules; bundle the payment SDK and verify its output without node_modules.
